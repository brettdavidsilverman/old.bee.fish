...
namespace bee::fish::parser {
   ...
   bool test() {
			   ...
			   // Hello or Goodbye
			   Match& helloGoodbyeTemplate =
			      Word("Hello") or Word("World") or Word("Goodbye");
			  
			   Match* helloGoodbye = helloGoodbyeTemplate.copy();
			   ok &= ( helloGoodbye->read("World") == true );
			   cerr << *helloGoodbye << endl;
			   cerr << ok << endl;
			
			   delete helloGoodbye;
			   
			   delete &helloGoodbyeTemplate;
			   
			   // Hello and World
			   Match& helloWorldTemplate =
			      Word("Hello") and Word("World");
			   Match* helloWorld = helloWorldTemplate.copy();
			   ok &= ( helloWorld->read("HelloWorld") == true );
			   cerr << *helloWorld << endl;
			   cerr << ok << endl;
			
			   delete helloWorld;
			   
			   delete &helloWorldTemplate;
			   ...
			   */
			   ...
			   Name name;
			   ok &= (name.read("BrettDavidSilverman") == true);
			   cerr << name << endl;
			   cerr << ok << endl;
			   
			   // Brett and Optional(David) and Silvermam
			   Match& nameTemplate =
			     Word("Brett") and Optional(new Word("David")) and Word("Silverman");
			   Match* name2 = nameTemplate.copy();
			   ok &= ( name2->read("BrettDavidSilverman") == true );
			   cerr << *name2 << endl;
			   cerr << ok << endl;
			   ...
			   // Brett and Silverman
			   name2 = nameTemplate.copy();
			   ok &= ( name2->read("BrettSilverman") == true );
			   cerr << *name2 << endl;
			   cerr << ok << endl;
