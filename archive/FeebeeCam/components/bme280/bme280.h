...
///
class BME280 : protected I2CMaster
{
/*
protected:
    virtual esp_err_t readRegister(uint8_t reg, uint8_t *data, size_t length = 1) = 0;
    virtual esp_err_t writeRegister(uint8_t reg, uint8_t data) = 0;
*/
public:
